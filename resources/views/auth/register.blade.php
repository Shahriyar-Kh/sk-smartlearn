    ...
    <div class="min-h-screen bg-gradient-to-br from-sky-50 to-blue-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-colors mb-6">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="text-center text-sm text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="text-sky-600 hover:underline font-semibold">Sign in</a>
                    </div>
                </form>
            </div>
